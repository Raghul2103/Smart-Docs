...
import { User as UserIcon, Mail, Lock, Loader2, FileText, Sun, Moon } from "lucide-react";
...
const Register = () => {
  ...
  const { register, user, theme, toggleTheme } = useContext(AuthContext);
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.success) {
      // Redirect to login with navigation state
        ...
        <div className="w-full max-w-md bg-white dark:bg-slate-900/40 backdrop-blur-lg border border-slate-200 dark:border-slate-800/80 rounded-3xl p-8 shadow-xl dark:shadow-2xl animate-in fade-in duration-500">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-1.5 text-center">
              Sign up to start creating and sharing documents
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800 focus:border-sky-500 focus:ring-1 focus:ring-sky-500 rounded-xl pl-10.5 pr-4 py-2.5 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-600 outline-none transition-all"
                />
              </div>
            </div>
          ...
          <div className="mt-8 text-center border-t border-slate-200 dark:border-slate-800/80 pt-6">
            <p className="text-slate-500 dark:text-slate-400 text-sm">
              ...
              <Link
                to="/login"
                className="text-sky-500 dark:text-sky-400 hover:text-sky-300 font-medium transition-colors"
              >
                Sign in
              </Link>
            </p>
